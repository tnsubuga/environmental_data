...
**The read.csv function converts a .csv file into tabulated data, converting it into a data frame.**s
...
**qbinorm() is the Quantile function for the binomial distribution that returns the value associated with a specific probability (quantile).**


Here is an example to determine the median of the binomial distribution  with parameters with 4 trials  and probability of success for each trial = 0.75
